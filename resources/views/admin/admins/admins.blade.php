                ...
                @foreach ($admins as $admin)
                  <tr>
                    ...
                    <td>
                      ...
                      @else
                        <a class="updateAdminStatus" id="admin-{{$admin['id']}}" admin_id="{{$admin['id']}}" href="javascript:(0);"><i style="font-size: 25px;" class="mdi mdi-bookmark-outline" status="Inactive"></i> </a>
                      @endif
                    </td>
                    <td>
                      @if ($admin['type'] == 'vendor')
                      <a href="{{route('admin.view.vendor.details', $admin['id'])}}">View</a>
                      @endif
                    </td>
                  </tr>
                @endforeach
